...
namespace ESolutions.Win32
{
	...
	{
		OCM__BASE = (WindowsMessages.WM_USER + 0x1c00),
		OCM_COMMAND = (OCM__BASE + WindowsMessages.WM_COMMAND),
		OCM_CTLCOLORBTN = (OCM__BASE + WindowsMessages.WM_CTLCOLORBTN),
		OCM_CTLCOLOREDIT = (OCM__BASE + WindowsMessages.WM_CTLCOLOREDIT),
		OCM_CTLCOLORDLG = (OCM__BASE + WindowsMessages.WM_CTLCOLORDLG),
		OCM_CTLCOLORLISTBOX = (OCM__BASE + WindowsMessages.WM_CTLCOLORLISTBOX),
		OCM_CTLCOLORMSGBOX = (OCM__BASE + WindowsMessages.WM_CTLCOLORMSGBOX),
		OCM_CTLCOLORSCROLLBAR = (OCM__BASE + WindowsMessages.WM_CTLCOLORSCROLLBAR),
		OCM_CTLCOLORSTATIC = (OCM__BASE + WindowsMessages.WM_CTLCOLORSTATIC),
		OCM_CTLCOLOR = (OCM__BASE + WindowsMessages.WM_CTLCOLOR),
		OCM_DRAWITEM = (OCM__BASE + WindowsMessages.WM_DRAWITEM),
		OCM_MEASUREITEM = (OCM__BASE + WindowsMessages.WM_MEASUREITEM),
		OCM_DELETEITEM = (OCM__BASE + WindowsMessages.WM_DELETEITEM),
		OCM_VKEYTOITEM = (OCM__BASE + WindowsMessages.WM_VKEYTOITEM),
		OCM_CHARTOITEM = (OCM__BASE + WindowsMessages.WM_CHARTOITEM),
		OCM_COMPAREITEM = (OCM__BASE + WindowsMessages.WM_COMPAREITEM),
		OCM_HSCROLL = (OCM__BASE + WindowsMessages.WM_HSCROLL),
		OCM_VSCROLL = (OCM__BASE + WindowsMessages.WM_VSCROLL),
		OCM_PARENTNOTIFY = (OCM__BASE + WindowsMessages.WM_PARENTNOTIFY),
		OCM_NOTIFY = (OCM__BASE + WindowsMessages.WM_NOTIFY)
	}
	#endregion
	...
	#region UpdateLayeredWindowsFlags
	...
	#region ColorMatchToTargetMode
	public enum ColorMatchToTargetMode
	{
		Enable = 1,
		Disable = 2,
		DeleteTransform = 3
	...
	#region RasterOperationCode
	public enum RasterOperationCode : int
	{
